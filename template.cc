...
void Print(const ll& x)     { printf("%" PRId64 "\n", x); }
void Print(const ull& x)    { printf("%" PRIu64 "\n", x); }
...
template<class ...T> void Print(const ll& x, const T& ...args)     { printf("%" PRId64 " ", x); Print(args...); }
template<class ...T> void Print(const ull& x, const T& ...args)    { printf("%" PRIu64 " ", x); Print(args...); }
...
void Read(ll& x)     { scanf("%" PRId64, &x); }
void Read(ull& x)    { scanf("%" PRIu64, &x); }
...
template<class ...T> void Read(ll& x, T& ...args)     { scanf("%" PRId64, &x);  Read(args...); }
template<class ...T> void Read(ull& x, T& ...args)    { scanf("%" PRIu64, &x);  Read(args...); }
...
//  Utility                                                                                                                   /
// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template<typename T> int Size(T elem) { return static_cast<int>(elem.size()); }
